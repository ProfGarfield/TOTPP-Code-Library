...
local backspaceAttack = {}

-- backspaceAttack[unitType.id]={
--
...
--local function canFireNuke(unit)
--    if object.wManhattanProject.city and unit.owner:hasTech(object.aRocketry) and unit.owner:hasTech(object.aNuclearFission) then
--        return true
--    else
--        text.simple(unit.type.name.." units can only fire "..object.uNuclearMsl.name.." units if the Manhattan Project has been built, and we know the secrets of "..object.aRocketry.name.." and "..object.aNuclearFission.name..".")
--        return false
--    end
--end
        

--backspaceAttack[object.uSubmarine.id] = {goldCost = 1500,moveCost = 3,allowedTerrainTypes={10,},
--        treasuryFailMessage = "This munition requires 1500 gold to fire.",
--        terrainTypeFailMessage = object.uSubmarine.name.." units can only fire "..object.uNuclearMsl.name.." units at sea.",
--        canGenerateFunction = canFireNuke,
--        payload = true,
--        payloadFailMessage = text.substitute("%STRING1 units can only fire %STRING2 units if they have a home city.",{object.uSubmarine.name,object.uNuclearMsl.name}),
--        generatedUnitType = object.uNuclearMsl, activate = true,}

return backspaceAttack
