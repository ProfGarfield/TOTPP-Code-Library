legacyEventBuilder = require("legacyEventBuilder")
...
local eventTextFileName="importevents.txt"
...
return legacyEventBuilder.buildLegacyEvents(writeTextFile,showEventParsed,eventTextFileName,eventOutputFileName,
